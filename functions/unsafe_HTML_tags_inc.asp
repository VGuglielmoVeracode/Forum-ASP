...
'Dimension variables
Dim saryUnSafeHTMLtags(216)	 'If you add more disallowed HTML tags then increase the array size
...
saryUnSafeHTMLtags(215) = "background-image"
saryUnSafeHTMLtags(216) = "video"

...
If blnActiveUsers Then
	...
	saryActiveUsers = activeUsers(strTxtForumClosed, "", "", 0)
End If
...
strBreadCrumbTrail = strBreadCrumbTrail & strNavSpacer & strTxtForumClosed
...
<table class="basicTable" cellspacing="0" cellpadding="3" align="center">
 <tr>
  <td align="left"><h1><% = strTxtForumClosed %></h1></td>
</tr>
</table>
<br />
<table cellspacing="1" cellpadding="3" class="tableBorder" align="center" width="350">
 <tr class="tableLedger">
  <td><% = strTxtForumClosed %></td>
 <tr class="tableRow">
  <td align="center"><br /><% = strTxtSorryTheForumsAreClosedForMaintenance %><br /><br /></td>
 </tr>
</table>
<br />
<div align="center">

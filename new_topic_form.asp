...
If blnPost = False AND intGroupID = 2 AND blnActiveMember AND blnForumLocked = false AND blnBanned = False Then blnSslEnabledPage = True
...
%>
<table class="errorTable" cellspacing="1" cellpadding="10" align="center">
  <tr>

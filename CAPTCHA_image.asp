...
strCharacterColour1 = bmpHexColourSwicth(strCharacterColour1)
strCharacterColour2 = bmpHexColourSwicth(strCharacterColour2)
...
For intRowLoop = 0 to 49
	...
	For intColumnLoop = 0 TO 119
		...
		ElseIf sarryCanvas(intRowLoop, intColumnLoop) = "2" Then
			If intRowLoop MOD 3 Then writeBinary(strCharacterColour1) Else writeBinary(strCharacterColour2)
